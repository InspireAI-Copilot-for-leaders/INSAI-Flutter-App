...
app.get("/", async (req, res) => {
  const dynamicLink = "https://inspireai.page.link?apn=com.panscience.inspireai&ibi=com.pansciece.inspireai&link=";
  const targetUrl = "https://inspireai.page.link/linkedinAuth";
