...
export 'create_from_scratch_model.dart';

class CreateFromScratchWidget extends StatefulWidget {
  const CreateFromScratchWidget({super.key});

  @override
  State<CreateFromScratchWidget> createState() =>
      _CreateFromScratchWidgetState();
}

class _CreateFromScratchWidgetState extends State<CreateFromScratchWidget> {
  late CreateFromScratchModel _model;
              ...
              children: [
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: _model.createWhat == 'article'
                            ? FlutterFlowTheme.of(context).accent2
                            : FlutterFlowTheme.of(context).tertiary,
                        borderRadius: BorderRadius.circular(18.0),
                      ),
                                            ...
                                            Expanded(
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText:
                                                      'Your Insight on the topic (optional)',
                                                  hintStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                                          .labelMedium
                                            ...
                                            Expanded(
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText:
                                                      'Intended target audience (optional)',
                                                  hintStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                                          .labelMedium
