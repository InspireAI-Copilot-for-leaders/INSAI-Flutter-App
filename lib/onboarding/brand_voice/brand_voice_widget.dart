...
class BrandVoiceWidget extends StatefulWidget {
  const BrandVoiceWidget({super.key});

  @override
  State<BrandVoiceWidget> createState() => _BrandVoiceWidgetState();
}

class _BrandVoiceWidgetState extends State<BrandVoiceWidget> {
  late BrandVoiceModel _model;
                ...
                child: Stack(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'BRAND_VOICE_PAGE_Row_tdtrkr8f_ON_TAP');
                    ...
                    Align(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'BRAND_VOICE_PAGE_Icon_3vp9cvr8_ON_TAP');
              ...
              children: [
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.contentURL1TextController2,
                                  focusNode: _model.contentURL1FocusNode2,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    hintText: 'We\'ll model content using this',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily:
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('BRAND_VOICE_PAGE_CONTINUE_BTN_ON_TAP');
                      if (_model.typedVoice != null &&
                          _model.typedVoice != '') {
