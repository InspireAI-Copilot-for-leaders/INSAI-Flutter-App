                  ...
                  child: Stack(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'EXPERTISE_AREA_EDIT_Row_y63k8gkv_ON_TAP');
                      ...
                      Align(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EXPERTISE_AREA_EDIT_Icon_5jaw85rr_ON_TAP');
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Wrap(
                                                                            ...
                                                                            clipBehavior:
                                                                                Clip.none,
                                                                            children:
                                                                                List.generate(expertiseArea.length, (expertiseAreaIndex) {
                                                                              final expertiseAreaItem = expertiseArea[expertiseAreaIndex];
                                                                              return InkWell(
                                                                                splashColor: Colors.transparent,
                                                                                focusColor: Colors.transparent,
                                                                                hoverColor: Colors.transparent,
                                                                                highlightColor: Colors.transparent,
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('EXPERTISE_AREA_EDIT_Container_vfwsle37_O');
                                                    ...
                                                    children: [
                                                      ...
                                                      Align(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'EXPERTISE_AREA_EDIT_+_ADD_NEW_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'EXPERTISE_AREA_EDIT_ADD_EXPERTISE_AREA_B');
                                                  logFirebaseEvent(
                                                      'Button_update_page_state');
                                                  _model.leadershipAreasMapping =
                                                      (currentUserDocument
                                            ...
                                            Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'EXPERTISE_AREA_EDIT_CANCEL_BTN_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Button_update_page_state');
                                                  _model.addNewArea = false;
                                                  setState(() {});
