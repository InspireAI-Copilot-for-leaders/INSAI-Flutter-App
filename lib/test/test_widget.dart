              ...
              Expanded(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<List<BroadDomainRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<BroadDomainRecord> containerBroadDomainRecordList =
                            snapshot.data!;
                        return Container(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'TEST_PAGE_SEND_TO_DOC_BTN_ON_TAP');
                                    while (_model.loopIndex <
                                        _model.uploadedFileUrls.length) {
                                      logFirebaseEvent('Button_backend_call');

                                      await containerBroadDomainRecordList[
                                              _model.loopIndex]
                                          .reference
                              ...
                              Builder(
                                builder: (context) {
                                  final containerVar =
                                      containerBroadDomainRecordList.toList();
