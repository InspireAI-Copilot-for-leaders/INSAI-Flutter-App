...
class EditBrandVoiceWidget extends StatefulWidget {
  const EditBrandVoiceWidget({super.key});

  @override
  State<EditBrandVoiceWidget> createState() => _EditBrandVoiceWidgetState();
}

class _EditBrandVoiceWidgetState extends State<EditBrandVoiceWidget> {
  late EditBrandVoiceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditBrandVoiceModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'editBrandVoice'});
    // On page load action.
              ...
              child: Stack(
                ...
                children: [
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('EDIT_BRAND_VOICE_Row_03zl9kiv_ON_TAP');
                  ...
                  Align(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'EDIT_BRAND_VOICE_Icon_n3utyaii_ON_TAP');
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'EDIT_BRAND_VOICE_CONTINUE_BTN_ON_TAP');
                        if (_model.typedVoice != null &&
                            _model.typedVoice != '') {
