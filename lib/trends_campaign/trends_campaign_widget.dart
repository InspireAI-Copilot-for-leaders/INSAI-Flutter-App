...
import 'trends_campaign_model.dart';
export 'trends_campaign_model.dart';

class TrendsCampaignWidget extends StatefulWidget {
  const TrendsCampaignWidget({super.key});

  @override
  State<TrendsCampaignWidget> createState() => _TrendsCampaignWidgetState();
}

class _TrendsCampaignWidgetState extends State<TrendsCampaignWidget> {
  late TrendsCampaignModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrendsCampaignModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'trendsCampaign'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('TRENDS_CAMPAIGN_close_rounded_ICN_ON_TAP');
                  ...
                  children: [
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'TRENDS_CAMPAIGN_Container_a456los6_ON_TA');
                                                              logFirebaseEvent(
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'TRENDS_CAMPAIGN_DO_THE_INSPIRE_A_I_MAGIC');
                          ...
                          if (isEntitled) {
                            if ((_model.dropDownValue1 == null) ||
                              ...
                              if ((_model.apiResulttd41?.succeeded ?? true)) {
                                logFirebaseEvent('Button_backend_call');
              ...
              if (_model.loadingScreenVisible == true)
                wrapWithModel(
                  ...
                  child: LoadingScreenWidget(
                    ...
                    callToAction: () async {
                      logFirebaseEvent(
                          'TRENDS_CAMPAIGN_Container_qagtsnc6_CALLB');
