        ...
        body: Container(
          ...
          child: Stack(
            children: [
                  ...
                  children: [
                        ...
                        children: [
                          Expanded(
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PAY_WALL_PAGE_Stack_u8kkn2kk_ON_TAP');
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Material(
                                        ...
                                        elevation: _model.isYearly ? 10.0 : 0.0,
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PAY_WALL_PAGE_Stack_ex1rph1t_ON_TAP');
                                logFirebaseEvent('Stack_update_page_state');
                                setState(() {
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PAY_WALL_CONTINUE_TO_PAYMENT_BTN_ON_TAP');
                          logFirebaseEvent('Button_update_page_state');
                          setState(() {
                            _model.paymentLoading = true;
                          });
                          ...
                          logFirebaseEvent('Button_update_page_state');
                          setState(() {
                            _model.paymentLoading = false;
                            _model.paymentButtonClicked = true;
                          });
                        },
              ...
              if (_model.paymentButtonClicked)
                Container(
                  width: double.infinity,
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  24.0, 0.0, 24.0, 0.0),
                                          child: Text(
                                            'Wait for new slots to open up or request for special access.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'PAY_WALL_PAGE_I_WILL_WAIT_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_update_page_state');
                                              setState(() {
                                                _model.paymentButtonClicked =
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    'You have been added to the waitlist. We will email you when slots open up.',
                                                    style: TextStyle(
                                                      color:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              onFieldSubmitted: (_) async {
                                                logFirebaseEvent(
                                                    'PAY_WALL_TextField_k7h56zt9_ON_TEXTFIELD');
                                                logFirebaseEvent(
